...
public class MusicPlayFragment extends Fragment implements View.OnClickListener {
    ...
    private View musicPlayFragmentView;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        musicPlayFragmentView = inflater.inflate(R.layout.fragment_music_play, container, false);
        initViews();
        return musicPlayFragmentView;
    }

    private void initViews() {
        btnBack = musicPlayFragmentView.findViewById(R.id.back);
    ...
    public void onClick(View view) {
        switch (view.getId()){
            case R.id.back:
                Log.d("hct","click");
            mediaActivity.switchFragment("musicPlayFragment","musicMainFragment");
                break;
        }
    }
